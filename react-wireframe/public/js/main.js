...
let MainContainer = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      'div',
      { style: backgroundColor, className: 'row' },
      React.createElement(LeftPane, null),
      React.createElement(RightPane, null)
    );
  }
});
...
},{"./LeftPane.jsx":161,"./RightPane.jsx":163,"react":157}],159:[function(require,module,exports){
let React = require('react');
...
let Card = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        { style: cardColor, className: "card" },
        React.createElement(
          "div",
          { className: "card-body" },
          this.props.mode === "plain" ? React.createElement(
            "h4",
            { style: textStyle },
            React.createElement(
              "strong",
...
let Label = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        { style: cardBorder, className: "card" },
        React.createElement(
          "div",
          { style: headingProps, className: "card-header" },
          React.createElement(
            "p",
            { style: textMargin },
        ...
        React.createElement("div", { style: bodyProps, "class": "card-body" })
      )
    );
  }
});
...
let LeftPane = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        'div',
        { style: topMargin, className: 'row' },
        React.createElement(Card, { cardValue: '20', cardDescription: 'New Followers added this month', mode: 'plain' }),
        React.createElement(Card, { cardValue: '$1250', cardDescription: 'Average Monthly Income', mode: 'plain' }),
        React.createElement(Card, { cardValue: '$13865', cardDescription: 'Yearly Income Goal', mode: 'plain' })
      ),
      React.createElement(
        'div',
        { className: 'row' },
        React.createElement(Panel, { panelValue: panelArray, backgroundColor: '#0096d0' })
      ),
      React.createElement(
        'div',
        { className: 'row' },
        React.createElement(Panel, { panelValue: panelArray, backgroundColor: '#cd59ae' })
      )
    );
  }
});
...
},{"./Card.jsx":159,"./Panel.jsx":162,"react":157}],162:[function(require,module,exports){
let React = require('react');
...
let Panel = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        { style: panelSize, className: "panel" },
        React.createElement("div", { style: panelBody, className: "panel-body" }),
        React.createElement(
          "div",
          { style: panelFooter, className: "panel-footer" },
          React.createElement(
            "div",
            { className: "row" },
            React.createElement(
              ...
              React.createElement(
                "h4",
                { style: marginBottomReset },
                this.props.panelValue.panelCol1.c1Value
              ),
              React.createElement(
                "p",
                { style: panelFooterDescColor },
                this.props.panelValue.panelCol1.c1Desc
              )
            ),
            React.createElement(
              "div",
              ...
              React.createElement(
                "h4",
                { style: marginBottomReset },
                this.props.panelValue.panelCol2.c2Value
              ),
              React.createElement(
                "p",
                { style: panelFooterDescColor },
                this.props.panelValue.panelCol2.c2Desc
              )
            ),
            React.createElement(
              "div",
              ...
              React.createElement(
                "h4",
                { style: marginBottomReset },
                this.props.panelValue.panelCol3.c3Value
              ),
              React.createElement(
                "p",
                { style: panelFooterDescColor },
                this.props.panelValue.panelCol3.c3Desc
              )
            )
          )
        )
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        'div',
        { style: topMargin, className: 'row' },
        React.createElement(Card, { cardValue: '18\xB0', cardDescription: 'Paris', mode: 'temp' }),
        React.createElement(Label, { labelDescription: 'New Visitors', labelValue: '1.5k', headingColor: '#0096d0', textColor: '#FFF' }),
        React.createElement(Label, { labelDescription: 'Bounce Rate', labelValue: '50%', headingColor: '#b28ad6', textColor: '#FFF' }),
        React.createElement(Label, { labelDescription: 'Searchs', labelValue: '28%', headingColor: '#ff4826', textColor: '#FFF' }),
        React.createElement(Label, { labelDescription: 'Traffic', labelValue: '140.5kb', headingColor: '#63c254', textColor: '#FFF' })
      )
    );
  }
});
...
},{"./Card.jsx":159,"./Label.jsx":160,"react":157}],164:[function(require,module,exports){
let React = require('react');
...
},{"./components/App.jsx":158,"react":157,"react-dom":28}]},{},[164]);
